...
interface IProps {
  ...
  setChange: React.Dispatch<React.SetStateAction<() => void | null>>;
}
...
class UserList extends Component<IProps, IState> {
  ...
  componentDidMount(): void {
    /* TODO was passiert bei Einsetzen der Komponenten */
    axios
  ...
  handleInputChange = (e: ChangeEvent<HTMLInputElement>) => {
    // TODO extract the function onChange from all input tags.
    // Make a User class.
    ...
    // (e) => this.handleInputChange(e, 'name')
  };
